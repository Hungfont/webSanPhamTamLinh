...
<footer>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-xs-12">
                        <div class="photo">
                            <a href="#"><img src="<c:url value='/images/logo.png' />" alt="images" class="img-responsive"></a>
                        </div>
                        <p class="info-desc">Truyền bá và số hóa đời sống tâm linh là sứ mệnh của chúng tôi. Mang lại giá trị và đời sống tâm linh tích cực.Tâm Linh Số trải nghiệm và tìm kiếm vật phẩm tâm linh, phong thủy, thờ cúng...</p>
                        <div class="widget-info">
                            <ul>
                                <li><i class="ion-ios-location fa-4" aria-hidden="true"></i>97 Man Thiện, Quận 9, Thành Phố Hồ Chí Minh</li>
                                <li class="clearfix"></li>
                                <li><i class="ion-ios-telephone fa-4" aria-hidden="true"></i>
                                    <p class="title-contain">0944043559</p>
                                </li>
                                <li class="clearfix"></li>
                                <li><i class="ion-email-unread fa-4" aria-hidden="true"></i>
                                    <p class="title-contain">n18dccn076@ptithcm.com</p>
                                </li>
                                <li class="clearfix"></li>
                            </ul>
                        </div>
        ...
        <div class="copyright">
            <div class="container">
                ...
                <ul class="payment">
                    <li><a href="#"><img src="<c:url value='/template/web/img/paypal.png' />" alt="images" class="img-responsive"></a></li>
                    <li><a href="#"><img src="<c:url value='/template/web/img/visa.png' />" alt="images" class="img-responsive"></a></li>
                    <li><a href="#"><img src="<c:url value='/template/web/img/american.png' />" alt="images" class="img-responsive"></a></li>
                    <li><a href="#"><img src="<c:url value='/template/web/img/mastercard.png' />" alt="images" class="img-responsive"></a></li>
                </ul>
